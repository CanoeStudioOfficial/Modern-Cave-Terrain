...
/**
 * Configuration options for Modern Cave Terrain.
 * <p>
 ...
 */
@Config(modid = ModernCaveTerrainSettings.MOD_ID, name = "moderncaveterrain-1_12_2")
public class Configuration {
    ...
    @Config.Comment("List of ID's of dimensions that will have Modern Cave Terrain. Ignored if Global Whitelisting is enabled.")
    @Config.RequiresWorldRestart
    public static int[] whitelistedDimensionIDs = {0};

    @Config.Name("Enable Global Whitelist")
    @Config.Comment(
            "Automatically enables Modern Cave Terrain in every possible dimension, except for the End.\n" +
