package com.lonelyxiya.minecraft.moderncaveterrain.util;

import com.lonelyxiya.minecraft.moderncaveterrain.config.Configuration;
...
/**
 * Utility functions for Modern Cave Terrain.
 * This class may not be instantiated - all members are {@code public} and {@code static},
 * and as such may be accessed freely.
 */
public class ModernCaveTerrainUtils {
    private ModernCaveTerrainUtils() {} // Private constructor prevents instantiation
