...
import com.lonelyxiya.minecraft.moderncaveterrain.enums.CavernType;
...
import com.lonelyxiya.minecraft.moderncaveterrain.world.carver.cavern.CavernCarver;
import com.lonelyxiya.minecraft.moderncaveterrain.world.carver.cavern.CavernCarverBuilder;
...
public class CavernCarverController {
    ...
    public CavernCarverController(World worldIn, ConfigHolder config) {
        ...
        ModernCaveTerrain.LOGGER.debug("CAVERN INFORMATION");
        ModernCaveTerrain.LOGGER.debug("--> SPAWN CHANCE SET TO: " + spawnChance);
        ...
        ModernCaveTerrain.LOGGER.debug("--> DEADZONE PERCENT: " + deadzonePercent + "(" + totalDeadzonePercent + " TOTAL)");
        ...
        for (CavernCarver carver : carvers) {
            ...
            ModernCaveTerrain.LOGGER.debug("    --> RANGE PERCENT LENGTH WANTED: " + rangeCDFPercent);
