package com.lonelyxiya.minecraft.moderncaveterrain.world.carver.cave;
...
public class CaveCarver implements ICarver {
    ...
    public CaveCarver(final CaveCarverBuilder builder) {
        ...
        if (bottomY > topY) {
            ModernCaveTerrain.LOGGER.warn("Warning: Min altitude for caves should not be greater than max altitude.");
