package com.lonelyxiya.minecraft.moderncaveterrain.world.carver.cavern;
...
import com.lonelyxiya.minecraft.moderncaveterrain.noise.NoiseGen;
import com.lonelyxiya.minecraft.moderncaveterrain.world.carver.CarverSettings;
...
/**
 * ModernCaveTerrain Cavern carver.
...
public class CavernCarver implements ICarver {
    ...
    public CavernCarver(final CavernCarverBuilder builder) {
        ...
        if (bottomY > topY) {
            ModernCaveTerrain.LOGGER.warn("Warning: Min altitude for caverns should not be greater than max altitude.");
            ModernCaveTerrain.LOGGER.warn("Using default values...");
            this.bottomY = 1;
            this.topY = 35;
        }
    }
