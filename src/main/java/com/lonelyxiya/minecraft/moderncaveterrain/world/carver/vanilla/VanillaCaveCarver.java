package com.lonelyxiya.minecraft.moderncaveterrain.world.carver.vanilla;
...
public class VanillaCaveCarver extends MapGenCaves implements ICarver {
    ...
    public VanillaCaveCarver(final VanillaCaveCarverBuilder builder) {
        ...
        if (bottomY > topY) {
            ModernCaveTerrain.LOGGER.warn("Warning: Min altitude for vanilla caves should not be greater than max altitude.");
